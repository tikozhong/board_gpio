...
*  PINs Define
**********************************************/
const PIN_T RUNNING = {SWCLK_BOOT_LED_GPIO_Port, SWCLK_BOOT_LED_Pin};
...
const PIN_T GPIO_INPUTS[GPIO_INPUTS_LEN] =
{
	...
	{IN12_GPIO_Port, IN12_Pin},
	{IN13_GPIO_Port, IN13_Pin},
	{IN14_GPIO_Port, IN14_Pin},
	{IN15_GPIO_Port, IN15_Pin}
};
